...
const translations = {
	en: {
		...
		// Hero
		hero_label: 'Solutions',
		hero_line1: 'Web',
		hero_line2: 'Development',
		hero_line2_mobile: 'Dev',
		hero_expertise: 'Websites • Automation • AI Solutions',
		hero_qualifier: 'From Idea to Launch',
	...
	it: {
		...
		hero_label: 'Soluzioni',
		hero_line1: 'Web',
		hero_line2: 'Development',
		hero_line2_mobile: 'Dev',
		hero_expertise: 'Siti Web • Automazione • Soluzioni AI',
		hero_qualifier: 'Dall\'Idea al Lancio',
