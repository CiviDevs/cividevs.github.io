...
export function initCustomCursor() {
    ...
    const addHoverListeners = () => {
        const hoverElements = document.querySelectorAll('a, button, [role="button"], [data-magnetic], .bento-cell, .project-item');
...
export function initRippleEffect() {
    ...
    const rippleElements = document.querySelectorAll('[data-ripple], .btn, .bento-cell, .project-item');
